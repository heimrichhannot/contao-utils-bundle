...
$GLOBALS['TL_LANG']['MSC']['utilsBundle'][\HeimrichHannot\UtilsBundle\Dca\DcaUtil::PROPERTY_AUTHOR_TYPE][\HeimrichHannot\UtilsBundle\Dca\DcaUtil::AUTHOR_TYPE_SESSION] = 'PHP-Sitzung';
 ...
 * Salutations
 */
$GLOBALS['TL_LANG']['MSC']['utilsBundle']['salutationFemale'] = 'Sehr geehrte Frau';
$GLOBALS['TL_LANG']['MSC']['utilsBundle']['salutationMale'] = 'Sehr geehrter Herr';
$GLOBALS['TL_LANG']['MSC']['utilsBundle']['salutationDivers'] = 'Guten Tag';
...
$GLOBALS['TL_LANG']['MSC']['utilsBundle']['genderOther'] = 'Divers';

$GLOBALS['TL_LANG']['MSC']['utilsBundle']['genderFe']['male'] = 'Herr';
$GLOBALS['TL_LANG']['MSC']['utilsBundle']['genderFe']['female'] = 'Frau';
$GLOBALS['TL_LANG']['MSC']['utilsBundle']['genderFe']['other'] = 'Divers';
