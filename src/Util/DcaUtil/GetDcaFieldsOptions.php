...
class GetDcaFieldsOptions
{
    ...
    {
        return [
            'onlyDatabaseFields' => $this->onlyDatabaseFields,
            'allowedInputTypes' => $this->allowedInputTypes,
            'evalConditions' => $this->evalConditions,
            'localizeLabels' => $this->localizeLabels,
            'skipSorting' => $this->skipSorting,
        ];
    }
